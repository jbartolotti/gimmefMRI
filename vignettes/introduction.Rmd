...
On the Synapse research server, a newer g++ version has already been installed, but you will need to configureR to use it. From the command line (not in R), run the following two commands:
